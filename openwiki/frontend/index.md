...
- [Administrator panel and history preview](admin-panel.md) - Admin-only browser workspace for tenant users, history, image policy, encrypted analysis-model role assignments, and styles, including page-local generated-image inspection.
