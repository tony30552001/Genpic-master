...
- [Administrator panel and history preview](admin-panel.md) - Admin-only browser workspace for tenant user, history, model-policy, and style operations, including page-local generated-image inspection.
...
- [Creation workspace, documents, and exports](create-workflows.md) - Main Pixora creation state, distinct storyboard and company-template presentation workflows, transformations, persistence, and exports.
