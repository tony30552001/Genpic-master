...
| Document upload formats, browser MIME fallback, document conversion, or document-analysis provider input | [creation workflows](frontend/create-workflows.md) and [AI generation](backend/ai-generation.md) | `src/lib/documentFormats.js`, `src/hooks/useDocumentAnalysis.js`, `api/_shared/documentParser.js`, `api/analyze-document/index.js`, `api/_shared/azureOpenAI.js` | `isSupportedDocumentFile`, `parseDocumentBuffer`, `generateJsonCompletion` | `src/lib/__tests__/documentFormats.test.js`, `api/_shared/__tests__/documentParser.test.js`, `api/_shared/__tests__/azureOpenAI.test.js` | `pnpm test --run src/lib/__tests__/documentFormats.test.js api/_shared/__tests__/documentParser.test.js api/_shared/__tests__/azureOpenAI.test.js` |
