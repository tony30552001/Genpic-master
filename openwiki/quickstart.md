...
| Creation UI, document scenes, document-style selection, transforms, exports, or generation progress | [creation workflows](frontend/create-workflows.md) | `src/InfographicGenerator.jsx`, `src/components/create/DocumentUploader.jsx`, `src/components/create/DocumentScenes.jsx` | `handleGenerateScene`, `AnalysisProgress`, `exportToPptx` | `src/services/__tests__/aiService.test.js`, `src/utils/__tests__/pptxExport.test.js` | `pnpm test --run src/services/__tests__/aiService.test.js src/utils/__tests__/pptxExport.test.js` |
