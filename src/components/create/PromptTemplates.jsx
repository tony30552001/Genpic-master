...
const TEMPLATES = [
  {
    ...
    palette: { paintStyle: ["寫實"], mood: ["溫暖"], lighting: ["柔和光"], color: ["乾淨"], composition: ["特寫"] },
  },
  {
    id: "t2",
    title: "雲端浮島",
    text: "雲海之上懸停著碎片群島與霧瀑，遠景遼闊，薄霧光環",
    palette: { paintStyle: ["繪本"], mood: ["夢幻"], lighting: ["柔和光"], composition: ["廣角"] },
  },
  {
    id: "t3",
    title: "童話氣球遊行",
    text: "童話小鎮的氣球遊行，小朋友在空中歡呼，甜美彩色氣球串",
    palette: { paintStyle: ["插畫"], mood: ["可愛"], color: ["繽紛"] },
  },
  {
    id: "t4",
    title: "水彩山嵐湖",
    text: "山嵐繚繞的湖面與杉林倒影，水彩暈染層次柔和",
    palette: { paintStyle: ["水彩"], mood: ["安靜"], lighting: ["柔和光"] },
  },
  {
    id: "t5",
    title: "像素霓虹街機",
    text: "8-bit 霓虹街機廊，雨後水漬倒影，速度感強",
    palette: { paintStyle: ["像素風"], mood: ["活力"], lighting: ["霓虹"] },
  },
  {
    id: "t6",
    title: "3D 爆炸結構",
    text: "金屬質感相機機身剖面展開示意，結構層次分明",
    palette: { paintStyle: ["3D"], material: ["金屬感"], composition: ["極簡"], color: ["低彩度"] },
  },
  {
    id: "t7",
    title: "電影感追逐",
    text: "未來城市磁浮列車疾駛追逐，高對比光影，電影感構圖",
    palette: { paintStyle: ["電影感"], lighting: ["高對比"], theme: ["未來感"], composition: ["廣角"] },
  },
  {
    id: "t8",
    title: "復古旅行海報",
    text: "復古假日海報，手繪字體與色塊構成，紙質顆粒感",
    palette: { paintStyle: ["插畫"], theme: ["復古"], material: ["紙質感"] },
  },
  {
    id: "t9",
    title: "玻璃未來展廳",
    text: "全玻璃展廳展示未來設備，空間極簡，線條乾淨",
    palette: { theme: ["未來感"], material: ["玻璃感"], composition: ["極簡"], color: ["乾淨"] },
  },
  {
    id: "t10",
    title: "陶瓷茶具特寫",
    text: "手作陶瓷茶壺特寫，釉色層次與微小裂紋清晰，背景簡潔",
    palette: { paintStyle: ["寫實"], material: ["陶瓷感"], lighting: ["柔和光"], lens: ["微距"] },
  },
  {
    id: "t11",
    title: "布料質感時裝",
    text: "層疊布料的時裝造型，材質細節細膩，背景簡潔",
    palette: { paintStyle: ["寫實"], material: ["布料感"], composition: ["特寫"], lighting: ["燈拍"] },
  },
  {
    id: "t12",
    title: "紙雕城市模型",
    text: "紙雕建築群模型，幾何建築層次清晰，光影溫潤",
    palette: { paintStyle: ["繪本"], material: ["紙質感"], lighting: ["柔和光"], color: ["乾淨"] },
  },
];
