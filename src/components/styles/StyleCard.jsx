            ...
            {style.tags.slice(0, 4).map((tag, i) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-2 py-0.5 text-xs transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${isActive
