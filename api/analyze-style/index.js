...
1. "style_prompt": (英文) 以完整句子寫成一段可重複使用的風格指示，描述藝術媒材、線條與形狀處理、配色、光影、表面質感及整體視覺氣質。
   這段文字會套用到不同主題，並由後端與內容、用途及畫布規則組裝。嚴禁提及原圖的具體主體、人物、物件、文字、品牌、固定位置或固定鏡位，也不要重複描述內容。不得輸出逗號分隔的關鍵字清單或 8K、masterpiece、best quality 等空泛品質詞。
